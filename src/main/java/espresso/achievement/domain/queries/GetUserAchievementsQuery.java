...
/**
 * Query for retrieving achievements for a specific user.
 * Can filter by date and limit the number of results returned.
 */
@Getter
@Setter
@AllArgsConstructor
public class GetUserAchievementsQuery extends CommonQuery {
    ...
    /**
     * The size type indicating how much detail to include in the response (SM, MD,
     * LG).
     */
