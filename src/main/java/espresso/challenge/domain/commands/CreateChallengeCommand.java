 ...
 * Contains all necessary data for challenge creation including title, description, skills, and visibility.
 */
@Getter
@Setter
public class CreateChallengeCommand extends CommonCommand {

    /**
     * The 7-character alphanumeric key of the user creating the challenge.
    ...
    /**
     * A detailed description of the challenge (maximum 1000 characters).
     */
    ...
    /**
     * The date when the challenge will be fulfilled. Must be today or in the future.
     */
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    @FutureOrPresent(message = "LOCALIZE: THE FULFILLMENT DATE CANNOT BE BEFORE TODAY")
    private Date fulfillmentDate;

    /**
     * Array of skill abbreviations associated with this challenge.
    ...
    /**
     * Whether the challenge should be publicly visible to other users.
            ...
            for (int i = 0; i < skills.length; i++) {
                ...
                if (skill != null && !skill.trim().isEmpty()) {
                    ...
                    if (!ChallengeConstants.ALLOWED_SKILLS.contains(normalizedSkill)) {
                        errors.add("skills[" + i + "]:" + String.format(ChallengeConstants.ERROR_INVALID_SKILL, skill));
                    }
                }
            }
        }
