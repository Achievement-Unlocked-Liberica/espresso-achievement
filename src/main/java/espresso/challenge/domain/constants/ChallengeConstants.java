...
/**
 * Constants related to challenges and media handling.
...
public final class ChallengeConstants {
    ...
    /**
     * List of allowed MIME content types for challenge media uploads.
     * Supports common image formats used for challenge media.
     */
     ...
     */
    public static final String ERROR_EMPTY_IMAGE = "LOCALIZE: CHALLENGE MEDIA CANNOT BE EMPTY";
    
    /**
     * Error message for when uploaded files exceed the maximum size limit.
     */
    public static final String ERROR_FILE_SIZE = "LOCALIZE: CHALLENGE MEDIA EXCEEDS MAXIMUM SIZE OF 10MB";
    ...
    /**
     * Maximum allowed file size for challenge media uploads (10MB in bytes).
     */
    public static final long MAX_FILE_SIZE_BYTES = 10 * 1024 * 1024; // 10MB for challenge media

    /**
     * Minimum required image dimension in pixels for challenge media.
     * Both width and height must be at least this size.
     */
    public static final int MIN_IMAGE_DIMENSION = 200; // pixels - larger minimum for challenge media
    
    /**
     * Maximum allowed image dimension in pixels for challenge media.
     * Both width and height must not exceed this size.
     */
    public static final int MAX_IMAGE_DIMENSION = 3000; // pixels
}
