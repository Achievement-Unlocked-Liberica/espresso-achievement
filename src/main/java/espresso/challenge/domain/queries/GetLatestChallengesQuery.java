...
/**
 * Query for retrieving the latest challenges from the system.
 * Can filter by date and limit the number of results returned.
 */
@Getter
@AllArgsConstructor
public class GetLatestChallengesQuery extends CommonQuery {
    ...
    private QuerySizeType size = QuerySizeType.md;
